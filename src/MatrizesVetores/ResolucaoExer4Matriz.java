...
public class ResolucaoExer4Matriz {

	public static void main(String[] args) {

		Scanner leia = new Scanner(System.in);

		// Iniciamos uma matriz quadrada, que possui a mesma quantidade de linhas e
		// colunas
		...
		for (int indiceI = 0; indiceI < matriz.length; indiceI++) {
			...
			for (int indiceJ = 0; indiceJ < matriz.length; indiceJ++) {
				...
				// A combinação Linha e Coluna indica a posição onde o numero digitado será
				// armazenado.
		...
		// Na Diagonal principal os índices dos elementos são iguais. Ex.: 0,0 - 1,1 -
		// 2,2
		for (int indiceI = 0; indiceI < matriz.length; indiceI++) {
